...
export const SHOP_ITEMS: ShopItem[] = [
  ...
  { id: "producer-4x4", name: "Producer", kind: "producer", width: 4, height: 4, cost: 100, unlock: { cost: 100 }, createActor: createProducer },
  { id: "consumer-4x4", name: "Consumer", kind: "consumer", width: 4, height: 4, cost: 100, unlock: { cost: 100 },createActor: createConsumer },
  ...
  { id: "producer-8x4", name: "Producer", kind: "producer", width: 8, height: 4, cost: 2000, createActor: createProducer },
  { id: "consumer-8x4", name: "Consumer", kind: "consumer", width: 8, height: 4, cost: 2000, createActor: createConsumer },
  ...
  { id: "line-producer-1x8", name: "Line Producer", kind: "producer", width: 1, height: 8, cost: 1000, createActor: createCircleProducer },
  { id: "line-consumer-1x8", name: "Line Consumer", kind: "consumer", width: 1, height: 8, cost: 1000, createActor: createCircleConsumer },

  { id: "line-producer-8x1", name: "Line Producer", kind: "producer", width: 8, height: 1, cost: 1000, createActor: createProducer },
  { id: "line-consumer-8x1", name: "Line Consumer", kind: "consumer", width: 8, height: 1, cost: 1000, createActor: createConsumer },
];
